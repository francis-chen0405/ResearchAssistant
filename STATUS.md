...
## 2026-09-04 - Active Codex checkout placement

The current working copy used by Codex is
`/Users/francischen/Library/CloudStorage/OneDrive2-EastsidePreparatorySchool/GitHub/ResearchAssistant`.
The repository remains on `master`; this note records the local file placement only. The
placement is not part of the product runtime contract, and user data must continue to use
