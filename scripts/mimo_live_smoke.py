"""Explicitly gated one-search/one-acquisition/one-LLM direct-MiMo smoke."""
...
from providers.config import LiveSmokeConfig, MimoConfig, WigoloConfig
...
_APPROVAL_PHRASE = "I_APPROVE_ONE_MIMO_LIVE_SMOKE"
...
def main() -> int:
    ...
    llm = XiaomiMimoAdapter(
        MimoConfig.from_environment(os.environ),
